...
import com.driver.Services.AirService;
...
public AirService airService;
    ...
    public String addHotel(@RequestBody Hotel hotel)
    {
        ...
        return airService.addHotel(hotel);
    }
    ...
    public String getHotelWithMostFacilities()
    {
        ...
        return airService.getHotelWithMostFacilities();
    }
    ...
    public int bookARoom(@RequestBody Booking booking){
        ...
        return airService.bookARoom(booking);
    }
    ...
    public int getBookings(@PathVariable("aadharCard")Integer aadharCard)
    {
        ...
        return airService.getBookings(aadharCard);
    }
    ...
    public Hotel updateFacilities(List<Facility> newFacilities,String hotelName){
        ...
        return airService.updateFacilities(newFacilities,hotelName);
    }
